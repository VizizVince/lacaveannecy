...
function applyConfig() {
    ...
    // Galerie
    if (CONFIG.images.galerie) {
        const g = CONFIG.images.galerie;
        
        if (g.principale) {
            setElement('galerie-img-1', 'src', g.principale.src);
            setElement('galerie-img-1', 'alt', g.principale.alt);
            setElement('galerie-tag-1', 'textContent', g.principale.tag);
            setElement('galerie-titre-1', 'textContent', g.principale.titre);
        }
        
        if (g.secondaire) {
            setElement('galerie-img-2', 'src', g.secondaire.src);
            setElement('galerie-img-2', 'alt', g.secondaire.alt);
            setElement('galerie-tag-2', 'textContent', g.secondaire.tag);
            setElement('galerie-titre-2', 'textContent', g.secondaire.titre);
        }
        
        if (g.tertiaire) {
            setElement('galerie-img-3', 'src', g.tertiaire.src);
            setElement('galerie-img-3', 'alt', g.tertiaire.alt);
            setElement('galerie-tag-3', 'textContent', g.tertiaire.tag);
            setElement('galerie-titre-3', 'textContent', g.tertiaire.titre);
        }
    }
